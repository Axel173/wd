                    ...
                    <div class="row center">
                        <div class="col s4 16">
                            <a href="/personal/login?auth=vk" class="waves-effect waves-light">
                                <img src="https://png.icons8.com/color/50/000000/vk-com.png" alt="vk">
                            </a>
                        </div>
                        <div class="col s4 16">
                            <a href="/personal/login?auth=fb" class="waves-effect waves-light">
                                <img src="https://png.icons8.com/color/50/000000/facebook.png" alt="facebook">
                            </a>
                        </div>
                        <div class="col s4 16">
                            <a href="/personal/login?auth=tw" class="waves-effect waves-light">
                                <img src="https://png.icons8.com/color/50/000000/twitter.png" alt="twitter">
                            </a>
                        </div>
                    </div>
                </div>
