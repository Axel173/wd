...
(function (a) {
    ...
    var g = a(window), f = g.width(), k = g.height();
    ...
    a.fn.lazyload = function (d) {
        function b(a) {
            var c = a.tagName.toLowerCase(), b = a.getAttribute("data-src");
        ...
        function f() {
            ...
            h.each(function () {
                var e = a(this);
                if (!(c.skip_invisible && !e.is(":visible") || a.abovethetop(this, c) || a.leftofbegin(this, c))) if (!a.belowthefold(this, c) && !a.rightoffold(this, c)) e.trigger("appear"), b = 0; else if (++b > c.failure_limit) return !1
            })
        }
